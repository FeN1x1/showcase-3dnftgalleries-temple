...
export default class Button implements IScript<Props> {
  clip = new AudioClip('649d5d96-18be-4f89-b592-f2dfce64b7fe/sounds/click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    button.addComponent(new GLTFShape('649d5d96-18be-4f89-b592-f2dfce64b7fe/models/Lever_Fantasy.glb'))
