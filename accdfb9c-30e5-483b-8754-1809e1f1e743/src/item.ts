...
export default class Button implements IScript<Props> {
  clip = new AudioClip('accdfb9c-30e5-483b-8754-1809e1f1e743/sounds/click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    button.addComponent(new GLTFShape('accdfb9c-30e5-483b-8754-1809e1f1e743/models/Pink_Fantasy_Button.glb'))
